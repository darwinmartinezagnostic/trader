...
if (Parametros.find().count() === 0){
	...
	Parametros.insert({ fecha : new Date(), dominio : "limites", nombre : "CantidasMinimaMuestreo", estado : true, valor : 100 , descripcion : "Valor de muestreos mínimos antes de invertir defecto 200" });
