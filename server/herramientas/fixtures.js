...
if (Parametros.find({ dominio : 'limites' }).count() === 0){
	...
	Parametros.insert({ fecha : new Date(), dominio : "limites", nombre : "CantidadMinimaMuestreo", estado : true, valor : 100 , descripcion : "Valor de muestreos mínimos antes de invertir defecto 100" });
