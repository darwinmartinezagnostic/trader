...
if (Parametros.find({ dominio : 'limites' }).count() === 0){
	...
	Parametros.insert({ fecha : new Date(), dominio : "limites", nombre : "CantMaximaDeCompras", estado : true, valor : 5 , descripcion : "Valor maximo de ejecución de compras a realizar, si el valor es = 9999999999 entonces la ejecución será infinita" });
