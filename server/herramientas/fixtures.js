...
if (Parametros.find().count() === 0){
	...
	Parametros.insert({ fecha : new Date(), dominio : "limites", nombre : "CantidadMinimaMuestreo", estado : true, valor : 20 , descripcion : "Valor de muestreos mínimos antes de invertir defecto 200" });
