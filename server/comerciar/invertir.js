...
Meteor.methods({
    ...
    'EvaluarTendencias':function( TIPOCAMBIO, MONEDASALDO ){
        ...
        log.info('-------------------------------------------');
        if ( MONEDASALDO === MonBase ){
            log.info("             BASE: ".green, Vmoneda_base,'Invertir');
            log.info("            FECHA: ".green, VBfecha,'Invertir');
        	log.info("  PRECIO ANTERIOR: ".green, "= ".green, ValPrecAntMB," =".green,'Invertir');
        	log.info("    PRECIO ACTUAL: ".green, "= ".green, ValPrecAct," =".green,'Invertir');
        	log.info("        TENDENCIA: ".green, "[[*** ".green, parseFloat(TendenciaMonedaBase.toFixed(4)) ," ***]]".green,'Invertir' );
    	}else{
            log.info("             BASE: ".grey, Vmoneda_base,'Invertir');
            log.info("            FECHA: ".grey, VBfecha,'Invertir')
    		log.info("  PRECIO ANTERIOR: ".grey, ValPrecAntMB,'Invertir');
    		log.info("    PRECIO ACTUAL: ".grey, ValPrecAct),'Invertir';
            if ( TendenciaMonedaBase === undefined) {
    		  log.info("        TENDENCIA: ".grey, '0','Invertir');
            }else{
              log.info("        TENDENCIA: ".grey, TendenciaMonedaBase,'Invertir');
            }
    	}
        log.info('-------------------------------------------');
        if ( MONEDASALDO === MonCoti ){
            log.info("       COTIZACION: ".green, Vmoneda_cotizacion,'Invertir');
            log.info("            FECHA: ".green, VCfecha,'Invertir');
        	log.info("  PRECIO ANTERIOR: ".green, "= ".green ,ValPrecAntMC," =".green,'Invertir');
        	log.info("    PRECIO ACTUAL: ".green, "= ".green ,ValPrecAct," =".green,'Invertir');
        	log.info("        TENDENCIA: ".green, "[[*** ".green, parseFloat(TendenciaMonedaCotizacion.toFixed(4)) ," ***]]".green,'Invertir' );
        }else{
            log.info("       COTIZACION: ".grey, Vmoneda_cotizacion,'Invertir');
            log.info("            FECHA: ".grey, VCfecha,'Invertir');
        	log.info("  PRECIO ANTERIOR: ".grey, ValPrecAntMC,'Invertir');
        	log.info("    PRECIO ACTUAL: ".grey, ValPrecAct,'Invertir');
            if ( TendenciaMonedaCotizacion === undefined) {
              log.info("        TENDENCIA: ".grey, 0,'Invertir');
            }else{
              log.info("        TENDENCIA: ".grey, TendenciaMonedaCotizacion,'Invertir');
            }
        }
    },
