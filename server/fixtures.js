...
if (Parametros.find().count() === 0){
	...
	Parametros.insert({ fecha : new Date(), dominio : "limites", nombre : "CantidasMinimaMuestreo", estado : true, valor : 500 , descripcion : "Valor de muestreos mínimos antes de invertir defecto 4" });
