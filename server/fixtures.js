...
if (Parametros.find().count() === 0){
	...
	Parametros.insert({ fecha : new Date(), dominio : "limites", nombre : "CantidasMinimaMuestreo", estado : true, valor : 14 , descripcion : "Valor de muestreos mínimos antes de invertir" });
